...
Most of these come down to network reality or how worldbank serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

worldbank rate-limits like any public site. worldbank already paces
...
Where a surface is gated, worldbank reads a cookie or token you supply
...
`worldbank`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what worldbank actually did
